...
DECLARE_MULTICAST_DELEGATE_OneParam(FOnPlayerStatChanged, int32 /*StartValue*/)
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnLevelChanged, int32 /*StartValue*/, bool /*bLevelUp*/);
/**
 * 
 */
UCLASS()
